  ...
  return (
    <Panel>
      <div>
        ...
        <Title>
          {props.isCompleted ? 'Review the resource summary' : 'Ready to complete?'}
        </Title>
      ...
      <Actions>
        ...
        {!props.isCompleted ? (
          <Button
            type="button"
            size="large"
            disabled={!props.canProvision || props.isProvisioning}
            onClick={props.onProvision}
          >
            {props.isProvisioning ? 'Provisioning…' : 'Provision resource'}
          </Button>
        ) : null}
      </Actions>
    </Panel>
